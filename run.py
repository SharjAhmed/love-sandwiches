...
def validate_data(values):
    ...
    try: 
        ...
        if len(values) != 6:
            raise ValueError(
                f"Exaclty 6 values required, you procided {len(values)}"
            )
...
#Refactored into single function below
...
def update_worksheet(data, worksheet):
    """
    Receives a ist of integers to be inserted into a woksheet
...
def calculate_surplus_data(sales_row):
    ...
    - Negative surplus indicates extra made when stick was sold out.
    """    
